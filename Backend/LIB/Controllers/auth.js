...
const SendVerifyEmail = async (email, username) => {
    ...
    const mailConfigurations = {
        ...
        text: `Hello! Please follow the given link to verify your email https://worldflow.azurewebsites.net/api/auth/verifyEmail/${token} Thanks`
    };
...
const SendResetPasswordEmail = async (email, password) => {
    ...
    const mailConfigurations = {
        ...
        // This would be the text of email body
        text: `Hello! Please follow the given link to reset your password https://worldflow.azurewebsites.net/api/auth/resetPassword/${token} Thanks`
    };
